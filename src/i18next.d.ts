/* tslint:disable */
/**
 * We can't use @types/i18next@8.4 with i18next@10.0.3 
 * So we declare partially without exporting
 * Copy of https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/i18next/index.d.ts Type definitions for i18next 8.4
 */
